        ...
        <div className="welcome_site">
          <div className="social-icons">
            <div className="github-container">
              <a
                href="https://github.com/szrederkarol1"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-40 -20 600 512">
            ...
            <div className="linkedin-container">
              <a
                href="https://www.linkedin.com/in/karol-szreder-043202267/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-70 -50 600 512">
