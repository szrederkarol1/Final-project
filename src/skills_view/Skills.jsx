          ...
          <h3 style={{color: "#ffff", fontFamily: "cursive", fontSize: "2em"}}>MY ARGUMENTS</h3>
            <div className="first_row_arguments ">
              <div className="item_arguments">
                ...
                <h3 style={{ color: "white", marginRight: "2em" }}>
                  JAVASCRIPT
                </h3>
              </div>
              <div className="item_arguments">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="-200 0 800 512"
                >
                  <path d="M0 32l34.9 395.8L191.5 480l157.6-52.2L384 32H0zm308.2 127.9H124.4l4.1 49.4h175.6l-13.6 148.4-97.9 27v.3h-1.1l-98.7-27.3-6-75.8h47.7L138 320l53.5 14.5 53.7-14.5 6-62.2H84.3L71.5 112.2h241.1l-4.4 47.7z" />
                </svg>
                <h3 style={{ color: "white", marginRight: "2em" }}>HTML</h3>
              </div>
              <div className="item_arguments">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="-200 0 900 512"
                >
                  <path d="M0 32l34.9 395.8L192 480l157.1-52.2L384 32H0zm313.1 80l-4.8 47.3L193 208.6l-.3.1h111.5l-12.8 146.6-98.2 28.7-98.8-29.2-6.4-73.9h48.9l3.2 38.3 52.6 13.3 54.7-15.4 3.7-61.6-166.3-.5v-.1l-.2.1-3.6-46.3L193.1 162l6.5-2.7H76.7L70.9 112h242.2z" />
                </svg>
                <h3 style={{ color: "white", marginRight: "3em" }}>CSS</h3>
              </div>
            </div>
            <div className="secondary_row_container">
              <div className="item_arguments">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="-200 0 800 512"
                ...
                <h3 style={{ color: "white", marginRight: "2em" }}>REACT</h3>
              </div>
            </div>
            <div className="thirty_row_arguments">
              <div className="item_arguments">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 700 512">
              ...
              <div className="item_arguments">
                ...
                <h3 style={{ color: "white", marginRight: "2em" }}>SCSS</h3>
              </div>
              <div className="item_arguments">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="-150 0 800 512"
                >
                ...
                <h3 style={{ color: "white", marginRight: "2em" }}>GITHUB</h3>
              </div>
            </div>
          </div>
        </div>
